...
export const LessonButton = ({
  ...
  // ✅ KEY FIX: completed lessons always go to /lesson/${id} for practice
  // locked lessons cannot be accessed
  // current lesson goes to /lesson (active)
  const href = isCompleted ? `/lesson/${id}` : locked ? "#" : "/lesson";
  ...
  return (
    ...
    >
      ...
      >
        {/* ✅ Show "Practice" badge on completed lessons */}
        {isCompleted && (
        ...
        {current ? (
          ...
          <Button
            ...
            className={cn(
              ...
              // ✅ Give completed lessons a distinct green ring so users know they're clickable
